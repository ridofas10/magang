...
$pemohon = new pemohon;
$get = $pemohon->getPemohonnonapprove();
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2> Daftar pemohon yang belum diterima </h2>
                ...
                <tbody>
                    ...
                    <?php foreach ($get as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="terima btn btn-primary" href="?status=<?= $row["id"]; ?>" onclick="return confirm('Yakin?');">Terima</a>
